...
```{r}
ozone <- read_csv("outputs/ice/ozone_2026-05-20.csv")
...
```{r}
npl <- read_csv("outputs/ice/npl_proximity_2026-05-20.csv")

rmp <- read_csv("outputs/ice/rmp_proximity_2026-05-20.csv")

haz <- read_csv("outputs/ice/hazardous_waste_proximity_2026-05-20.csv")
