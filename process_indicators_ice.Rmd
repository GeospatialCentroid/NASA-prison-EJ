...
flood_risk <- read_csv("outputs/flood_risk_2026-04-03.csv") %>%
  select(FACILITYID, flood_risk = flood_risk_percent)

wildfire_risk <- read_csv("outputs/wildfire_risk_2026-02-12.csv")

heat_exp <- read_csv("data/phase2/processed/lst/lst_MODIS_average_2026-04-29.csv")

canopy_cover <- read_csv("data/phase2/processed/canopy_cover/prison_canopy_AK.csv") %>%
  bind_rows(read_csv("data/phase2/processed/canopy_cover/prison_canopy_HI.csv")) %>%
  bind_rows(read_csv("data/phase2/processed/canopy_cover/prison_canopy_CONUS.csv")) %>% 
...
```{r}
ozone <- read_csv("outputs/ozone_2026-04-17.csv")

pm25 <- read_csv("outputs/pm25_2026-03-26.csv")

pesticides <- read_csv("outputs/pesticides_2026-04-27.csv")

traffic <- read_csv("outputs/traffic_proximity_2026-04-14.csv")
...
```{r}
npl <- read_csv("outputs/npl_proximity_2026-03-11.csv")

rmp <- read_csv("outputs/rmp_proximity_2026-04-29.csv")

haz <- read_csv("outputs/hazardous_waste_proximity_2026-04-29.csv")
...
final_df %>% st_as_sf() %>% write_sf(paste0("outputs/final_df_", Sys.Date(), ".gpkg"))
