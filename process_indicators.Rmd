...
pesticides <- calc_pesticides(prisons,
                              path = "data/phase2/raw/pesticide/EPest_county_estimates_2019.txt",
                              save = TRUE,
                              output_dir = "outputs/")
```
...
heat_exp <- read_csv("data/phase2/processed/lst/prison_lst_landsat_daily_summer_2022_2025.csv") %>% 
  select(FACILITYID, LST_mean)
...
rmp <- read_csv("outputs/rmp_proximity_2026-02-11.csv")

haz <- read_csv("outputs/hazardous_waste_proximity_2026-02-12.csv")
