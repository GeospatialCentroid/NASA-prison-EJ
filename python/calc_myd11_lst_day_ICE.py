...
"""
Created April 2026
Updated: for ICE detention facilities (point geometries)
...
def reduceRegions(image):
  ice_buffered = ice.map(lambda f: f.buffer(1000))
  
  LST_mean = (image
             .reduceRegions(
                 collection=ice_buffered,
...
task = ee.batch.Export.table.toDrive(
  ...
  folder="gee_exports",
  description='ice_lst_daily_MODIS_2026-05-19',
  fileFormat='CSV'
)
