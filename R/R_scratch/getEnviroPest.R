...
#'
#' @param trimmedPDF A subset of the CalEnviroScreen report PDF with the pesticides table
...
getEnviroPest <- function(trimmedPDF = "data/raw/pesticide_sedac/CalEnviroScreen40_PESTICIDE_LIST.pdf",
                          save = TRUE, writePath = "data/processed/"){
