...
#' 
#' "Some more function description here"
#' 
#' 
#' @param filePath relative path to csv of HAPS data
#' @param geometry f object of the census block group, census track, or county
#' 
